...
const computeTimeLeft = (): TimeLeft | null => {
...
const DigitTile = ({
  ...
  <motion.div
    ...
    transition={{ delay: 0.05 + index * 0.08, duration: 0.3, ease: EASE }}
...
const Separator = ({ index }: Readonly<{ index: number }>) => (
  <motion.div
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    transition={{ delay: 0.1 + index * 0.08, duration: 0.3, ease: EASE }}
